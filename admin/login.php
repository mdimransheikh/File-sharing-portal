...
<?php 
	...
	$query = "SELECT * FROM tbl_admin WHERE Name='$username' AND Password='$password'";
...
?>
				<form class="form-horizontal" method="post" action="">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control1" id="focusedinput" name="Name" placeholder="Please enter your username">
						</div>
					</div>
